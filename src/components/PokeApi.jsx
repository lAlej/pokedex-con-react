...
function PokeApi () {
    ...
    async function pokemonData () {
        ...
        for(let i = primerDato ; i < segundoDato ; i++ ) {
            const responseData = await fetch(`https://pokeapi.co/api/v2/pokemon/${i}`);
            ...
            <div className="container">
                <div className="searchContainer" >
                    <form className="formContainer" onSubmit={handleSubmit} >
                        <input type="text" onChange={(e) => setBuscar(e.target.value)} value={buscar} />
                        <button onClick={handleClick}>Buscar</button>
                    </form>
                    <p className="error" style={{visibility:"hidden"}} >Escribe el nombre de un pokemon</p>
                </div>
                {
                    loaded ? 
                    ...
                    <div className="pokemonsContainer">
                        ...
                        <button className="btnCargarMas" onClick={pokemonData}>Cargar mas</button>
                    </div>
            ...
            <div>
                {
                    ...
                    loadSpecPokemon ? <PokemonSpecs specPokemon={specPokemon} backToList={handleBack} /> : < ListLoaded />
        ...
        <div>
            {
                ...
                loadBuscar ? <SearchPokemon  buscarPokemon={buscar} backToList={handleBack} /> : < LoadPrincipal />
